...
from shared.settings import MISTRAL_API_KEY, _OpenApi_PLANNER_MODEL, DEBUG_PATH
...
class PlannerAgent:
    ...
    def run(self, state: GraphState) -> GraphState:
        try:
            ...
            # debug_plan.json -> sur le volume, plus dans le dossier courant
            os.makedirs(DEBUG_PATH, exist_ok=True)
            with open(os.path.join(DEBUG_PATH, "debug_plan.json"), "w", encoding="utf-8") as f:
